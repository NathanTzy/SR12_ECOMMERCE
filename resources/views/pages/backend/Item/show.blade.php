                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="kuantitas" class="form-control @error('kuantitas') is-invalid @enderror"
                        ...
                        <div class="form-group">
                            ...
                            @if ($item->img && file_exists(public_path('storage/' . $item->img)))
                                <img src="{{ asset('storage/' . $item->img) }}" alt="Item" width="120" class="rounded">
                            @else
