    ...
    <div class="modal-dialog">
        <form method="POST" action="{{ route('payment-proof.store') }}" enctype="multipart/form-data"
            ...
            <div class="modal-body p-4">
                ...
                <!-- Info Bank -->
                <div id="paymentInfo" class="border rounded p-3 mb-3" style="display: none;">
                ...
                <div class="mb-4 px-3 px-md-4">
                    ...
                    <div class="list-group shadow-sm rounded">
                        ...
                        @foreach ($cartItems as $item)
                            @php
                                $name = $item->item->nama;
                                $qty = $item->qty;
                                $harga = $item->harga_saat_itulah;
                                $diskon = $item->diskon ?? 0;
                                $subtotalBarang = $qty * $harga * (1 - $diskon / 100);
                            ...
                            <div
                                ...
                                <div class="text-end w-100 text-md-end fw-semibold text-dark">
                    ...
                    <div class="mt-4 p-3 rounded bg-light border">
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class="d-flex justify-content-between fw-bold mt-2 fs-5 text-success border-top pt-2">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        select.addEventListener("change", function() {
            ...
            if (option.value !== "") {
                bankNama.textContent = option.getAttribute("data-nama");
                bankAtasNama.textContent = option.getAttribute("data-atas-nama");
                bankNoRek.textContent = option.getAttribute("data-no-rekening");
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        checkoutModal.addEventListener("shown.bs.modal", function() {
            ...
            // Hitung ongkir per item kalau provinsi sumsel
            ...
            const totalBayarEl = document.getElementById("modalTotalBayar");
            if (totalBayarEl) {
                totalBayarEl.textContent = `Rp${totalDenganOngkir.toLocaleString("id-ID")}`;
            }
        });
